...
<div class="card m-2">
  <div class="card-header d-flex justify-content-end gap-2">
	...
	<buton type="button" class="btn btn-outline-share" id="${id}" onclick="shareCard.apply(this, arguments)"><i class="fas fa-share-alt" id="${id}" onclick="shareCard.apply(this,arguments)"></i><button>
  </div>
  <img
    src=${imageUrl}
